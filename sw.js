...
const CACHE = 'les4cases-v118';
const PREFIXE = 'les4cases-';
const ASSETS = ['./','./index.html','./manifest.json',
  './accueil.webp','./accueil-yeux.webp','./accueil-bouche.webp','./rara.webp','./rara-yeux.webp','./rara-bouche.webp','./rara-bras.webp','./icon-192.png','./icon-512.png','./icon-180.png','./icon-maskable-512.png','./favicon.ico'];
